...
function preload() { //loading assets
  ...
  intro = loadImage("bg_assets/Intro.png");
  ...
  Mother = loadImage("character_assets/Mother.png");
  black = loadImage("bg_assets/black.jpeg");
}
...
function scene0() {
  ...
  fill(218, 226, 200);
  textSize(50);
  text("The Family Dinner", 250, 500);
  textFont(twFont);
  textSize(25);
  text("\[Click to begin\]", 250, 550);
...
function scene14() {
  ...
  makeTextbox();
  textStyleSpeakerName("JASPER (brother)");
  textStyleTextBox("\"Things have… changed a lot since you’ve been gone. Our sister, River, there’s something amiss \nwith her.\"");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 15;
  }
...
function scene18() //convo with river
{
  ...
  textStyleTextBox("\"Hey, can I confide in you? I feel like you'd understand. I've never felt like I belonged here. \nMother - she's always looked down on me. She’s vicious about the way I dress, and she conveniently \nforgets to invite me to family gatherings because I make them look bad. \nYou would know if you were around more…\"");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 19;
  }
...
function scene28() //open letters
{
  ...
  makeTextbox();
  textStyleSpeakerName("YOU");
  textStyleTextBox("You can feel your heart in your throat. \nYour hands are shaking so hard you can barely keep your grip on the pages. \nYour head is pounding, thoughts racing…");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 29;
  }
...
{
  background(riverBedroom);;
  image(RiverHappy, 0, 0);
  makeTextbox();
  textStyleSpeakerName("RIVER (sister)");
  textStyleTextBox("\"I'm going to have to kill you now. What a shame...\"");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 42;
  }
...
function scene37() //leave
{
  background(carriage);
  makeTextbox();
  textStyleTextBox("You leave with your luggage by carriage. By dawn, you are gone. You are safe. Or are you...?");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 43;
  }
...
function scene38() {
  ...
  makeTextbox();
  textStyleSpeakerName("RIVER (sister)");
  textStyleTextBox("\"Not long ago, I received a letter from my biological mother. \nShe explained that 22 years ago, our father had an affair when your mother was pregnant. \nYour mother lost her child when she gave birth, but the mistress - my mother gave birth to a \n healthy baby girl. Our father refused to let her keep their child, taking her baby to pass it as \nhis own. I'm your half-sister.\"");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 39;
  }
...
function scene39() {
  ...
  makeTextbox();
  textStyleSpeakerName("RIVER (sister)");
  textStyleTextBox("\"I knew you'd understand. I don't want to see you get hurt \nYou should leave before things get ugly...\"");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 37;
  }
...
function scene40() {
  ...
  makeTextbox();
  textStyleSpeakerName("RIVER (sister)");
  textStyleTextBox("\"Mother, you do that yourself just fine.\"");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 18;
  }
...
//Scene 42, death
function scene42() {
  background(black); // change background !!!!
  textStyleTextBox("*You have been killed*");
  if (mouseIsPressed == true) {
    mouseIsPressed = false;
    stage = 43;
  }
...
//Scene 43, end game screen
function scene43() {
  background(black);
  rectMode(CORNER);
  fill(218, 226, 200);
  textSize(25);
  text("Thanks for playing <3", 450, 350);
  textFont(twFont);
}
